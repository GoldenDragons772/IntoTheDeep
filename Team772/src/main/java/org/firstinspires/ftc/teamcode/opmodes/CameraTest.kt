...
class CameraTest : CommandOpMode() {
    ...
    override fun run() {
        ...
        telem.addData("Theta",inputValue)
        telem.update()
    ...
    override fun initialize() {
        ...
        telem = MultipleTelemetry(telemetry, FtcDashboard.getInstance().telemetry)
        sampleDetector = RedSampleDetection(telemetry);
