...
import org.firstinspires.ftc.teamcode.auto.ReflectedBucketAutoPaths as BucketAutoPaths
...
@Autonomous(name = "Reflected Bucket")
class ReflectedBucket(): CommandOpMode() {
