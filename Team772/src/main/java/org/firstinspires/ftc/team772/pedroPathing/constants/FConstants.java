...
public class FConstants {
    static {
        ...
        FollowerConstants.leftRearMotorName = "BRMotor";
        FollowerConstants.rightFrontMotorName = "FRMotor";
        FollowerConstants.rightRearMotorName = "BLMotor";
        ...
        FollowerConstants.xMovement = 60.2807;
        FollowerConstants.yMovement = 46.8113;

        FollowerConstants.forwardZeroPowerAcceleration = -27.1394;
        FollowerConstants.lateralZeroPowerAcceleration = -77.5786;
        ...
        FollowerConstants.zeroPowerAccelerationMultiplier = 13;
